...
function (_Events) {
  ...
  function DatePicker(target, options) {
    ...
    if (props.multiple) {
      value = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["isArray"])(value) ? value[0] : value;
    }
    ...
    states.bindValue = states.value; // 多选使用multipleValue

    states.multipleValue = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["isArray"])(value) ? value : value ? [value] : [];

...
function bindEvents() {
  ...
  handles.nodeClick = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_3__["proxy"])(states.$el, Selectors.inner, function (event) {
    ...
    if (props.nodeClickCheck && props.checkable && !node.disabled) {
      var $check = this.querySelector(Selectors.input);
...
/*!****************************!*\
  !*** ./src/utils/utils.js ***!
  \****************************/
/*! exports provided: isString, isObject, isPlainObject, isArray, isFunction, isPrimitive, isBoolean, isNumber, isNumberString, isInteger, isFloat, isElement, isDate, isEmpty, hasKey, toArray, mixins, objectClone, hyphenate, escapeRegExp, getObjectValue, uuid, throwError, compareJson, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _src_components_input_number__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../src/components/input-number */ "./src/components/input-number/index.js");
...
Nova.InputNumber = _src_components_input_number__WEBPACK_IMPORTED_MODULE_0__["default"];
window.Nova = Nova;
...
const Radio = __webpack_require__(/*! ../docs/components/radio.md */ "./examples/docs/components/radio.md");

const Switch = __webpack_require__(/*! ../docs/components/switch.md */ "./examples/docs/components/switch.md");

const Modal = __webpack_require__(/*! ../docs/components/modal.md */ "./examples/docs/components/modal.md");

const Breadcrumb = __webpack_require__(/*! ../docs/components/breadcrumb.md */ "./examples/docs/components/breadcrumb.md");

const Badge = __webpack_require__(/*! ../docs/components/badge.md */ "./examples/docs/components/badge.md");

const InputNumber = __webpack_require__(/*! ../docs/components/input-number.md */ "./examples/docs/components/input-number.md");
...
router.set('/').set('/button', setPage(Button, 'Button')).set('/input', setPage(Input, 'Input')).set('/checkbox', setPage(Checkbox, 'Checkbox')).set('/radio', setPage(Radio, 'Radio')).set('/switch', setPage(Switch, 'Switch')).set('/breadcrumb', setPage(Breadcrumb, 'Breadcrumb')).set('/badge', setPage(Badge, 'Badge')).set('/modal', setPage(Modal, 'Modal', runScript)).set('/input-number', setPage(InputNumber, 'InputNumber', runScript)).init(); // events 

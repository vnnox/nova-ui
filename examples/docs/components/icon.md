  ...
  export default {
    data () {
      return {
        font: 32,
        color: '#464c5b',
        icons: 'care,doc-help,language,email,menu,list-add,user,bell,upload,gear,export,move,copy,delete,edit,add,search,zoom-out,zoom-in,check,close,arrow-left,arrow-right,arrow-down,arrow-up,plus,minus,caret-top,caret-bottom,arrow-d-left,arrow-d-right,font-color,bold,italic,underline,shield,map,redo,undo,back,circle-check,circle-close,circle-minus,time,circle-warning,circle-info,circle-plus,circle-remove,square-help,square-danger,play,pause,warning2,release,server-add,light,power,proofread-time,reboot,screen-power,play-circle,video-switch,volume,remote-log,player-log,pack-up,spread,vert-center,vert-bottom,vert-top,vert-fill,hori-center,hori-right,hori-left,hori-fill,dustbin,clear,setting,fullscreen1,move-up,move-down,order,random,screen-close,screen-open,flow,mall,help,warning,info,count,info-square,cart,yuan,refresh,eye,filter,list,download,fullscreen'.split(','),
      }
    },
    computed: {
      styles() {
